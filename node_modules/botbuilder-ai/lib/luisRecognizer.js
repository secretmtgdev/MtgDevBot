 ...
 */
const azure_cognitiveservices_luis_runtime_1 = require("azure-cognitiveservices-luis-runtime");
...
class LuisRecognizer {
    constructor(application, options, includeApiResults) {
        ...
        this.luisClient = new azure_cognitiveservices_luis_runtime_1.LUISRuntimeClient(creds, baseUri);
    }
    /**
    ...
    recognize(context) {
        ...
        if (!cached) {
            ...
            return this.luisClient.prediction.resolve(this.application.applicationId, utterance, {
    ...
    prepareErrorMessage(error) {
        ...
        if (error.response && error.response.statusCode) {
            switch (error.response.statusCode) {
                ...
                default:
                    error.message = [
                        `Response ${error.response.statusCode}: Unexpected status code received.`,
